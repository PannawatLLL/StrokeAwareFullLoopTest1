      ...
      {patientData && (
        <>
          ...
          <div ref={formRef} className="form-container">
            <img src="/StrokeAwareResultForm.png" alt="Stroke Form" className="form-background" />
            ...
            <div className="overlay birthDate">{patientData.birthDate}</div>
            ...
            {patientData.balanceResult === 'yes' && <div className="overlay checkbox balance-yes">✓</div>}
            {patientData.balanceResult === 'no' && <div className="overlay checkbox balance-no">✓</div>}


            {patientData.eyeTestResult === 'yes' && <div className="overlay checkbox eye-yes">✓</div>}

            {patientData.faceAsymmetryResult === 'yes' && <div className="overlay checkbox face-yes">✓</div>}
            {patientData.faceAsymmetryResult === 'no' && <div className="overlay checkbox face-no">✓</div>}

            {patientData.armResult === 'yes' && <div className="overlay checkbox arm-yes">✓</div>}
            {patientData.armResult === 'no' && <div className="overlay checkbox arm-no">✓</div>}

            {patientData.speechResult === 'yes' && <div className="overlay checkbox speech-yes">✓</div>}
            {patientData.speechResult === 'no' && <div className="overlay checkbox speech-no">✓</div>}
          </div>
        </>
      )}
    </div>
